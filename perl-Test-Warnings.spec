...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETHER/Test-Warnings-0.036.tar.gz
...
%prep
%setup -q -n Test-Warnings-0.036
cd %{_builddir}/Test-Warnings-0.036
pushd ..
cp -a Test-Warnings-0.036 buildavx2
popd
