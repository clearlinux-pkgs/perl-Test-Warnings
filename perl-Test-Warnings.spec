...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETHER/Test-Warnings-0.034.tar.gz
...
%prep
%setup -q -n Test-Warnings-0.034
cd %{_builddir}/Test-Warnings-0.034
pushd ..
cp -a Test-Warnings-0.034 buildavx2
popd
