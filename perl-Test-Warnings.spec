...
%prep
%setup -q -n Test-Warnings-0.028
cd %{_builddir}/Test-Warnings-0.028
...
cp %{_builddir}/Test-Warnings-0.028/LICENCE %{buildroot}/usr/share/package-licenses/perl-Test-Warnings/69164988444003f1e2f00c57246af36c37320094
if test -f Makefile.PL; then
