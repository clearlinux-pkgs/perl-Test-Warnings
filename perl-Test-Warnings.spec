...
Source0  : https://cpan.metacpan.org/authors/id/E/ET/ETHER/Test-Warnings-0.033.tar.gz
...
%prep
%setup -q -n Test-Warnings-0.033
cd %{_builddir}/Test-Warnings-0.033
pushd ..
cp -a Test-Warnings-0.033 buildavx2
popd
